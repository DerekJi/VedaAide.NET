// Intentionally empty designer — InitialSchema migration owns the full snapshot.
...
{
    // [Migration] attribute intentionally removed so EF ignores this class
    // when building the migration chain. See InitialSchema for the full schema.
    [DbContext(typeof(VedaDbContext))]
    partial class Sprint4_FixModelSnapshot
    {
        /// <inheritdoc />
